                    ...
                    <div class="search-box__input-container bg-brown pd-10">
                        ...
                        <ul class="home-filter home-filter--list">
                            <li class="home-filter__item home-filter__item-location pd-10">
                                <div class="select-text" v-on:click="toggleParentLocation()" disabled>
                                ...
                                <div class="listing-filter-popup listing-filter-popup-location-inner" v-show="parentLocationState">
                                    <div class="listing-filter-popup-header gray-text pd-10" disabled>Chọn khu vực</div>
                                    <div class="listing-filter-popup-body gray-text pd-10">
                                        ...
                                        <div class="filter-popup-body-select-item pd-10">
                                            ...
                                            {{ currentCityName }}</div>
                                            <div class="filter-popup-body-select-item-icon city-icon-group flex-center" ref="cityIcons">
                                                ...
                                                <i class="bi bi-x gray-text flex-center" 
                                                    ...
                                                    @click="rightArrowIconState =!rightArrowIconState;
                                    ...
                                    <div class="listing-filter-popup-location-body gray-text pd-10">
                                        ...
                                        <div class="listing-filter-city-location" v-show="cityState">
                                            <div class="filter-popup-body-select-item pd-10"
                                                ...
                                                v-on:click="toggleDetailLocation();toggleCity(index); toggleParentLocation(); toggleIcons()">
                            ...
                            <li class="home-filter__item home-filter__item-progress-general home-filter__item-cost pd-10 ml-10 mr-10">
...
export default {
    ...
    methods:{
        ...
        toggleIcons(){
            this.$refs.cityIcons.ightArrowIconState = !this.rightArrowIconState ; 
            this.$refs.cityIcons.closeIconStatex = !this.closeIconState;
        },
